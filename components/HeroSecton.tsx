        ...
        <div>
          ...
          <div className='flex '>
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit  hover:scale-105 translate-1 duration-300 '>
                <img src={'https://images.hamro-files.com/0Eax843A8YitB_1mmnamMCR4Mbo=/300x300/smart/https://rpcdn.ratopati.com/media/albums/chimpanji-zoo_11_YmO428Poid.jpg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit   hover:scale-105 translate-1 duration-300 '>
                <img src={'https://images.hamro-files.com/SAelTjr-ZkUeYzppgpHQgIeIHwE=/300x300/smart/https://12khari.top/uploads/posts/WhatsApp-Image-2025-06-17-at-5.03.33-PM-1750166350.jpeg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit  hover:scale-105 translate-1 duration-300 '>
                <img src={'https://images.hamro-files.com/NlV6UZAkeYF7j-takD8fifvMzJI=/300x300/smart/https://www.onlinekhabar.com/wp-content/uploads/2025/06/Dharan-jhadap-1.jpg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit rounded  hover:scale-105 translate-1 duration-300 '>
                <img src={'https://images.hamro-files.com/uavSnYB8V8Hjf02_Kxd-FLHE69Q=/300x300/smart/https://rpcdn.ratopati.com/media/albums/darchula_rFBrYPWETi.jpg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit rounded   hover:scale-105 translate-1 duration-300'>
                <img src={'https://images.hamro-files.com/0MkBGlOrLp0VWEOo9KFXN3os9Y4=/300x300/smart/https://12khari.top/uploads/posts/badhi12-1727595344.jpg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
              ...
              <div className=' rounded-full mx-3 my-3 relative w-fit  drop-shadow-2xl  drop-shadow-inherit  rounded  hover:scale-105 translate-1 duration-300'>
                <img src={'https://images.hamro-files.com/MAfrA7GfdoMO9TQNr4I0t9x98ck=/300x300/smart/https://npcdn.ratopati.com/media/news/494839341_1443127663525714_8329134232679631152_n_frkh2d7XoG.jpg'} className='h-48 w-33 text-ellipsis object-cover bg-gradient-to-b from-gray-600 opacity-0 to-black opacity-100 '
                />
